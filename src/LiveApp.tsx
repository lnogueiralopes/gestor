...
export default function LiveApp() {
  ...
  const [form, setForm] = useState({ family_id: '1', ean: '', sku: '', id_produto: '', name: '', short_title: '', brand: '', origin: '', winery: '', vintage: '', size: '', varietal: '', product_type: '', summary: '', description: '', unit_cost: '0.00', target_margin: '0.00', stock_on_hand: '0', is_active: true });
