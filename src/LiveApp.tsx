...
export default function LiveApp() {
  ...
  return <div className="app"><Sidebar /><main className="rocketWorkspace">
    <header className="pageHeader"><div><h1>Produtos</h1></div><ActionPanel onAdd={()=>openForm()} addLabel="Novo produto" search={search} onSearch={formOpen?undefined:setSearch}/></header>
