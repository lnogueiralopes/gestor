...
const paths:Record<string,[string,string,string]>={
 ...
 '/precificador':['Canais de venda','Precificador','/precificador'],
 '/precificador/tabelas-conta':['Canais de venda','Precificador','/precificador'],
 '/precificador/tabelas-preco':['Canais de venda','Precificador','/precificador'],
 '/precificador/parametros':['Canais de venda','Precificador','/precificador'],
 '/precificador/custos':['Canais de venda','Precificador','/precificador'],
